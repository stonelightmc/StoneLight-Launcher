...
APP_TITLE = "StoneLight Launcher v0.6.71"
...
def attach_button_hover_effect(button, normal_height: int = UI_BUTTON_HEIGHT, hover_delta: int = 0):
    ...
    v0.6.71: no size changes on hover. Changing button height makes Tk grid recalculate
...
class StoneLightLauncherApp(ctk.CTk):
    ...
    def build_ui(self):
        ...
        # v0.6.71: hidden to keep the main screen compact; detailed info is in the instance window.
        ...
        # v0.6.71: hidden to keep the main screen compact; the restriction is enforced when adding offline accounts.
        ...
        # v0.6.71: hidden to keep the Java card compact.
        ...
        # v0.6.71: watermark removed from the main status card; the logo remains in the header and splash screen.
        ...
        self.log_box.insert("end", tr_service("Добро пожаловать в StoneLight Launcher v0.6.71") + "\n")
