(() => {
  ...
  const app = {
    ...
    render() {
      ...
      $("#versionLabel").textContent = `v${window.SLLState.launcher?.version || "0.6.69"}`;
    },
    ...
    openAboutDialog() {
      ...
      const version = launcher.version || "0.6.69";
    ...
    async openInstanceEditor(instanceId = "") {
      ...
      // v0.6.69: version pickers open only by pressing the load buttons.
