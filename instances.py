...
def default_official_instance(config: dict) -> dict:
    return {
        ...
        "modpack_url": config.get("official_modpack_fallback_url") or config.get("mods_zip_url", ""),
        "modpack_sha256": config.get("official_modpack_fallback_sha256") or config.get("mods_zip_sha256", ""),
        ...
        "icon": "assets/stonelight_logo_128.png",
        "icon_pack_id": "stonelight",
    }
...
def normalize_instance(inst: dict, config: dict) -> dict | None:
    ...
    return {
        ...
        "icon": inst.get("icon", ""),
        "icon_pack_id": inst.get("icon_pack_id", ""),
        "source": inst.get("source", {}) if isinstance(inst.get("source", {}), dict) else {},
    }
