...
# v0.5.49: official StoneLight pre-launch update flow.
for _lang, _mapping in {
    "en": {
...
# v0.5.49: update service messages.
for _lang, _mapping in {
    "en": {
...
# v0.5.49: shorter update buttons and clearer update-service messages.
for _lang, _mapping in {
    "en": {
        "Обновления": "Updates",
        "Установить": "Install",
...
# v0.5.49: dynamic update-error localization and missing launcher release handling.
for _lang, _mapping in {
    "en": {
...
# v0.5.49: update flow cleanup and startup message localization.
for _lang, _mapping in {
    "en": {
        "Готов к запуску.": "Ready to launch.",
        "Готово.": "Ready.",
...
# v0.5.49: centralized service/status/log localization.
for _lang, _mapping in {
    "en": {
