...
TRANSLATIONS = {
    "en": {
        ...
        "Добро пожаловать в StoneLight Launcher v0.5.27\n": "Welcome to StoneLight Launcher v0.5.27\n",
    ...
    "uk": {
        ...
        "Добро пожаловать в StoneLight Launcher v0.5.27\n": "Ласкаво просимо до StoneLight Launcher v0.5.27\n",
    ...
    "kk": {
        ...
        "Добро пожаловать в StoneLight Launcher v0.5.27\n": "StoneLight Launcher v0.5.27-ға қош келдіңіз\n",
...
# Extra UI translations added in v0.5.27.
