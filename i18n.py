...
# v0.6.68: official StoneLight pre-launch update flow.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: update service messages.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: shorter update buttons and clearer update-service messages.
for _lang, _mapping in {
    "en": {
        "Обновления": "Updates",
        "Установить": "Install",
...
# v0.6.68: dynamic update-error localization and missing launcher release handling.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: update flow cleanup and startup message localization.
for _lang, _mapping in {
    "en": {
        "Готов к запуску.": "Ready to launch.",
        "Готово.": "Ready.",
...
# v0.6.68: centralized service/status/log localization.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: Java preset helper text.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: instance combo label fallback translations.
for _lang, _mapping in {
    "en": {
        "официальная": "official",
        "пользовательская": "custom",
...
# v0.6.68: Java manual-only selector and compact settings.
for _lang, _mapping in {
    "en": {
        "Для этого пресета путь java.exe не нужен": "This preset does not need a java.exe path",
        "Путь к java.exe": "Path to java.exe",
...
# v0.6.68: Microsoft account chooser and install queue throttling.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: stable button grid, short dashboard labels.
for _lang, _mapping in {
    "en": {
...
# v0.6.68: backend/status/log message localization for Web UI.
...
# v0.6.68: instance icon pack backend messages.
...
# v0.6.68: Modrinth backend messages.
...
# v0.6.68: Modrinth timeout/retry messages.
...
# v0.6.68: Modrinth modpack import messages.
...
# v0.6.68: Modrinth target-instance install messages.
...
# v0.6.68: strict Modrinth modpack compatibility messages.
...
# v0.6.68: Modrinth filter install messages.
...
# v0.6.68: CurseForge backend messages.
...
# v0.6.68: Modrinth modpack update messages.
...
# v0.6.68: Modrinth smart prune status messages.
