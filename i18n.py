...
# v0.5.75: official StoneLight pre-launch update flow.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: update service messages.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: shorter update buttons and clearer update-service messages.
for _lang, _mapping in {
    "en": {
        "Обновления": "Updates",
        "Установить": "Install",
...
# v0.5.75: dynamic update-error localization and missing launcher release handling.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: update flow cleanup and startup message localization.
for _lang, _mapping in {
    "en": {
        "Готов к запуску.": "Ready to launch.",
        "Готово.": "Ready.",
...
# v0.5.75: centralized service/status/log localization.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: Java preset helper text.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: instance combo label fallback translations.
for _lang, _mapping in {
    "en": {
        "официальная": "official",
        "пользовательская": "custom",
...
# v0.5.75: Java manual-only selector and compact settings.
for _lang, _mapping in {
    "en": {
        "Для этого пресета путь java.exe не нужен": "This preset does not need a java.exe path",
        "Путь к java.exe": "Path to java.exe",
...
# v0.5.75: Microsoft account chooser and install queue throttling.
for _lang, _mapping in {
    "en": {
...
# v0.5.75: stable button grid, short dashboard labels.
for _lang, _mapping in {
    "en": {
