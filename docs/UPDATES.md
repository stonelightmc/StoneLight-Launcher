...
StoneLight Launcher v0.6.70 adds the first update system.
...
## v0.6.70 official pre-launch update
...
## v0.6.70 Windows EXE self-update
...
## v0.6.70 nested Windows update fix
