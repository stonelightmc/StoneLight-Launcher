...
StoneLight Launcher v0.5.55 adds the first update system.
...
## v0.5.55 official pre-launch update
...
## v0.5.55 Windows EXE self-update
...
## v0.5.55 nested Windows update fix
