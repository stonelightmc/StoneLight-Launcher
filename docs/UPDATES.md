...
StoneLight Launcher v0.6.66 adds the first update system.
...
## v0.6.66 official pre-launch update
...
## v0.6.66 Windows EXE self-update
...
## v0.6.66 nested Windows update fix
