...
StoneLight Launcher v0.5.62 adds the first update system.
...
## v0.5.62 official pre-launch update
...
## v0.5.62 Windows EXE self-update
...
## v0.5.62 nested Windows update fix
