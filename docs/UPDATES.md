...
StoneLight Launcher v0.5.56 adds the first update system.
...
## v0.5.56 official pre-launch update
...
## v0.5.56 Windows EXE self-update
...
## v0.5.56 nested Windows update fix
