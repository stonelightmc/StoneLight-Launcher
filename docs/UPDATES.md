...
StoneLight Launcher v0.6.69 adds the first update system.
...
## v0.6.69 official pre-launch update
...
## v0.6.69 Windows EXE self-update
...
## v0.6.69 nested Windows update fix
