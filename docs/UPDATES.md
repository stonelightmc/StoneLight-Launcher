...
StoneLight Launcher v0.5.64 adds the first update system.
...
## v0.5.64 official pre-launch update
...
## v0.5.64 Windows EXE self-update
...
## v0.5.64 nested Windows update fix
