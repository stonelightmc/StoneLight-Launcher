...
StoneLight Launcher v0.5.75 adds the first update system.
...
## v0.5.75 official pre-launch update
...
## v0.5.75 Windows EXE self-update
...
## v0.5.75 nested Windows update fix
