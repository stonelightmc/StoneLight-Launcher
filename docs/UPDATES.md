...
StoneLight Launcher v0.6.71 adds the first update system.
...
## v0.6.71 official pre-launch update
...
## v0.6.71 Windows EXE self-update
...
## v0.6.71 nested Windows update fix
