...
StoneLight Launcher v0.5.54 includes a first localization layer.
...
## v0.5.54 update service localization
...
- `launcher_gui.py` now imports `re`, required by `tr_service()` and `tr_update_error()`.
