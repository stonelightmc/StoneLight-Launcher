# StoneLight Launcher v0.6.67

Unofficial AI-coded Minecraft launcher with custom instances, account management and Modrinth integration.

## Features

- Microsoft licensed account login with local OAuth callback.
- Offline accounts are available after at least one licensed account exists locally.
- Official StoneLight instance with a separate update flow.
- Custom MultiMC-like instances.
...
- Legacy Forge compatibility fixes for older Minecraft versions.
- Languages:
  - English;
  - Ukrainian;
  - Kazakh.
...
- Вхід через ліцензійний Microsoft-акаунт із локальним OAuth callback.
- Offline-акаунти доступні після додавання хоча б одного ліцензійного акаунта.
- Офіційна збірка StoneLight з окремим механізмом оновлення.
- Користувацькі збірки у стилі MultiMC.
- Підтримка Vanilla / Fabric / Forge / Quilt / NeoForge.
...
- Виправлення сумісності Legacy Forge для старих версій Minecraft.
- Мови:
  - англійська;
  - українська;
  - казахська.
