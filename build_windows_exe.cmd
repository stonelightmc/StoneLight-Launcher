...
powershell -NoProfile -ExecutionPolicy Bypass -Command "if (Test-Path 'StoneLightLauncher_v0_6_68_Windows.zip') { Remove-Item 'StoneLightLauncher_v0_6_68_Windows.zip' -Force }; Compress-Archive -Path 'dist\StoneLight Launcher\*' -DestinationPath 'StoneLightLauncher_v0_6_68_Windows.zip'"
if errorlevel 1 (
...
echo   StoneLightLauncher_v0_6_68_Windows.zip
echo.
pause
